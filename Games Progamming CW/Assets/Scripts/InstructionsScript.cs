...
public class InstructionsScript : MonoBehaviour {
	...
	void OnGUI () {
		...
		GUI.Label (new Rect (25, 25, 300, 200), "The following are basic instructions for the Barrel Hunting game");
	    ...
	    GUI.Label (new Rect (125, 250, 100, 100),"4. If you wish to leave at anytime hit Esc key to show mouse cursor");
		GUI.Label (new Rect (125, 350, 100, 100),"5. Good Luck");
